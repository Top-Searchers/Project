...
const TweeterSectionBanner = () => {
    return (
      ...
      <img src="/channel.jpg" alt="" className='h-[131px]' />
      <p className='ml-[50px] h-[16vh] flex items-center font-[500]  '>सूची</p>
         </section>
      <section className='flex mt-[20px]'>
        <img src="/onetwo.jpg" alt=""  className='h-[131px]'/>
        <p  className='ml-[50px] h-[16vh] flex items-center font-[500]  '>चैनल</p>
